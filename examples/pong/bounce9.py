...
class Ball:
    ...
    def __init__(self, canvas, paddle, color):
        ...
        # by default, the ball has not hit the bottom of the canvas (yet)
    ...
    def draw(self):
        ...
        if pos[1] <= 0:
            self.y = 1
        if pos[3] >= self.canvas_height: # When the ball hits the bottom of the screen
...
while 1:
    # if the ball hasn't hit the bottom, continue to update the game
